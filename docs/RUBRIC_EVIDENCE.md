...
| README & setup | [README.md](../README.md) | `python -m pytest -q` | `139 passed`; README setup/run/test commands work as written. |
...
## Verify everything
```
python -m pytest -q     # -> 139 passed, fully offline
```
